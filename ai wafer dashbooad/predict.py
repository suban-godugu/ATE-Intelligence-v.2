...
# Robust model path lookup
def get_model_path():
    script_dir = os.path.dirname(os.path.abspath(__file__))
    candidates = [
        os.path.join(script_dir, "models", "wafer_model.pth"),
        os.path.join(script_dir, "..", "ai model", "models", "wafer_model.pth"),
        os.path.join(os.getcwd(), "models", "wafer_model.pth"),
        os.path.join("/app", "models", "wafer_model.pth"),
        os.path.join(script_dir, "wafer_model.pth"),
    ]
    for path in candidates:
        if os.path.exists(path):
            return path
    return os.path.join(script_dir, "models", "wafer_model.pth")
